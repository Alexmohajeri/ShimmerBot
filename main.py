...
send_to_channel: The channel ID to send the message - int
role_tag_id: The ID of the role to tag in the message put into <>, can be replaced with any string if you want - str
"""
send_to_channel = 0
role_tag_id = ""
